  ...
  return (
    <section className="py-16 px-4 flex flex-col items-center justify-center bg-gray-50">
      <div className="max-w-[1920px] mx-auto">
        <h1 className="text-center text-[#591C1C] text-4xl md:text-5xl my-10 font-['WomanFontBold']">
          Trouver un magasin
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
          ...
          >
            <div className="relative overflow-hidden rounded-lg h-[700px] group transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl">
              <img
                src="Thestore.png"
                alt="Fiori Les Berges du Lac"
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
              />
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white bg-[#591C1C]/90
                             transition-all duration-300 group-hover:bg-[#591C1C] group-hover:h-1/3">
                <p className="text-2xl leading-relaxed mb-2 font-['WomanFontBold']">
                  Rue du Lac Tibériade,<br />
                  Les Berges du lac, La Marsa, Tunisia
                </p>
                <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-sm font-['WomanFontBold']">
